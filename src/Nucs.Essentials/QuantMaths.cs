...
public static class QuantMathsExtensions {
...
public static class QuantMaths {
    #region Regular
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool IsMissingValue(double lhs) {
        return Math.Abs(lhs - AbstractInfrastructure.MissingValue) < 0.00000001;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool IsMissingValue(int lhs) {
        return lhs == AbstractInfrastructure.MissingValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool HasValue(double lhs) {
        return Math.Abs(lhs - AbstractInfrastructure.MissingValue) > 0.00000001;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool HasValue(int lhs) {
        return lhs != AbstractInfrastructure.MissingValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool IsMissingValueOrZero(double lhs) {
        return lhs == 0d || Math.Abs(lhs - AbstractInfrastructure.MissingValue) < 0.00000001;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool IsMissingValueOrZero(int lhs) {
        return lhs == AbstractInfrastructure.MissingValue || lhs == 0;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool HasNonZeroOrMissingValue(double lhs) {
        return lhs != 0d && Math.Abs(lhs - AbstractInfrastructure.MissingValue) > 0.00000001;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool HasNonZeroOrMissingValue(int lhs) {
        return lhs != AbstractInfrastructure.MissingValue && lhs != 0;
    }
