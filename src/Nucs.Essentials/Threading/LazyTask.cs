...
namespace Nucs.Threading {
    ...
    internal class LazyHelper {
        ...
        internal static LazyHelper Create(LazyThreadSafetyMode mode, bool useDefaultConstructor) {
            switch (mode) {
                ...
                default:
                    throw new ArgumentOutOfRangeException(nameof(mode), "Lazy_ctor_ModeInvalid");
            }
        }

        internal static Task<T> CreateViaDefaultConstructor<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T>() {
            try {
    ...
    /// <remarks>
    /// <para>
    /// By default, all public and protected members of <see cref="LazyTask{T}"/> are thread-safe and may be used
    ...
    public class LazyTask<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T> {
        private static Task<T> CreateViaDefaultConstructor() =>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LazyTask{T}"/> class that
        ...
        /// concurrently.
        /// </remarks>
        public LazyTask(Task<T> value) {
            _value = value;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="LazyTask{T}"/> class that uses a
        ...
        /// An instance created with this constructor may be used concurrently from multiple threads.
        /// </remarks>
        public LazyTask(Func<Task<T>> valueFactory)
            : this(valueFactory, LazyThreadSafetyMode.ExecutionAndPublication, useDefaultConstructor: false) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="LazyTask{T}"/>
        ...
        /// </param>
        public LazyTask(bool isThreadSafe) :
        ...
        public LazyTask(LazyThreadSafetyMode mode) :
            this(null, mode, useDefaultConstructor: true) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="LazyTask{T}"/> class
        ...
        public LazyTask(Func<Task<T>> valueFactory, bool isThreadSafe) :
        ...
        public LazyTask(Func<Task<T>> valueFactory, LazyThreadSafetyMode mode)
            : this(valueFactory, mode, useDefaultConstructor: false) { }

        private LazyTask(Func<Task<T>>? valueFactory, LazyThreadSafetyMode mode, bool useDefaultConstructor) {
        ...
        private void PublicationOnly(LazyHelper publicationOnly, Task<T> possibleValue) {
        ...
        internal Task<T>? ValueForDebugDisplay {
            get {
                if (!IsValueCreated) {
                    return default;
                }
        ...
        /// <summary>Gets a value indicating whether the <see cref="LazyTask{T}"/> has been initialized.
        /// </summary>
        /// <value>true if the <see cref="LazyTask{T}"/> instance has been initialized;
        /// otherwise, false.</value>
        /// <remarks>
        /// The initialization of a <see cref="LazyTask{T}"/> instance may result in either
        ...
        /// cref="LazyTask{T}"/>.</summary>
        /// <value>The lazily initialized value of the current <see
        /// cref="LazyTask{T}"/>.</value>
        /// <exception cref="System.MissingMemberException">
        /// The <see cref="LazyTask{T}"/> was initialized to use the default constructor
        ...
        /// The <see cref="LazyTask{T}"/> was constructed with the <see cref="System.Threading.LazyThreadSafetyMode.ExecutionAndPublication"/> or
        ...
        /// Please <see cref="System.Threading.LazyThreadSafetyMode"/> for more information on how <see cref="LazyTask{T}"/> will behave if an exception is thrown
        /// from initialization delegate.
        /// </remarks>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public Task<T> Value => _state == null ? _value! : CreateValue();
    }
    ...
    internal sealed class LazyDebugView<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T> {
        ...
        private readonly LazyTask<T> _lazy;
        ...
        public LazyDebugView(LazyTask<T> lazy) {
            _lazy = lazy;
        }
        ...
        public Task<T>? Value => _lazy.ValueForDebugDisplay;
