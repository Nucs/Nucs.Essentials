...
public class AsyncManyProducerManyConsumerStackTests {
    private readonly ITestOutputHelper Console;

    public AsyncManyProducerManyConsumerStackTests(ITestOutputHelper console) {
        Console = console;
    }

    [Fact]
    public void SequentialEnqDeq() {
        var queue = new AsyncManyProducerManyConsumerStack<int>();
